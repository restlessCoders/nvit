...
function time_slots() {
    $time_slots = array(
        array('id' => '1','time' => 'Morning (9am - 1pm)','status' => '1'),
        array('id' => '2','time' => 'Noon (2pm - 6pm)','status' => '1'),
        array('id' => '3','time' => 'Evening (6pm - 9pm)','status' => '1'),
        array('id' => '4','time' => 'Crash','status' => '1'),
    );
    return $time_slots;
}
function batch_slots() {
    $batch_slots = array(
        array('id' => '1','slotName' => 'sat-mon-wed','status' => '1'),
        array('id' => '2','slotName' => 'sun-tue-thu','status' => '1'),
        array('id' => '3','slotName' => 'fri-sat','status' => '1'),
    );
    return $batch_slots;
}
function classrooms() {
    $classrooms = array(
        array('id' => '1','classroom' => '1','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '2','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '3','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '4','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '5','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '6','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '7','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
        array('id' => '1','classroom' => '8','pc_seat'=>10,'no_pc_seat'=>10,'status' => '1'),
    );
    return $classrooms;
}
function courses() {
    $courses = array(
        array('id' => '1','courseName' => 'Microsoft Office Application','status' => '1'),
        array('id' => '2','courseName' => 'GPH','status' => '1'),
        array('id' => '3','courseName' => 'A+','status' => '1'),
        array('id' => '4','courseName' => 'Web Design','status' => '1'),
        array('id' => '5','courseName' => 'Web Dev','status' => '1'),
        array('id' => '6','courseName' => 'MCSE','status' => '1'),
        array('id' => '7','courseName' => 'Microsoft - C#','status' => '1'),
        array('id' => '8','courseName' => 'Win Form Applications - C#','status' => '1'),
        array('id' => '9','courseName' => 'C / C++ Programming','status' => '1'),
        array('id' => '10','courseName' => 'JAVA Programming','status' => '1'),
        array('id' => '11','courseName' => 'MCSD','status' => '1'),
        array('id' => '12','courseName' => 'CCNA','status' => '1'),
        array('id' => '13','courseName' => 'Linux','status' => '1'),
        array('id' => '14','courseName' => 'Auto CAD','status' => '1'),
        array('id' => '15','courseName' => 'PLC','status' => '1'),
        array('id' => '16','courseName' => 'Oracle - Developer','status' => '1'),
        array('id' => '17','courseName' => 'Oracle - Administrator(DBA)','status' => '1'),
        array('id' => '18','courseName' => 'SQL Server 2K14 - Developer','status' => '1'),
        array('id' => '19','courseName' => 'SQL Server 2K14 - Administrator','status' => '1'),
        array('id' => '20','courseName' => 'MNEP - 1','status' => '1'),
        array('id' => '21','courseName' => 'MNEP- 2','status' => '1'),
        array('id' => '22','courseName' => 'MNEP- 3','status' => '1'),
        array('id' => '23','courseName' => 'Exchange Server 2013','status' => '1'),
        array('id' => '24','courseName' => 'Micro Controller','status' => '1'),
        array('id' => '25','courseName' => 'Android Programming','status' => '1'),
        array('id' => '26','courseName' => 'WordPress','status' => '1'),
        array('id' => '27','courseName' => 'Outsourcing Guideline','status' => '1'),
        array('id' => '28','courseName' => 'MS Project','status' => '1'),
        array('id' => '29','courseName' => 'PMP (PMI)','status' => '1'),
        array('id' => '30','courseName' => 'OCP','status' => '1'),
        array('id' => '31','courseName' => 'MS Access','status' => '1'),
        array('id' => '32','courseName' => 'Advance MS Excel','status' => '1'),
        array('id' => '33','courseName' => 'MS Excel for Accounting','status' => '1'),
        array('id' => '34','courseName' => 'Network+','status' => '1'),
        array('id' => '35','courseName' => 'Python','status' => '1'),
        array('id' => '36','courseName' => 'Adobe Premiere Pro','status' => '1'),
        array('id' => '37','courseName' => 'WordPress with HTML & CSS','status' => '1'),
        array('id' => '38','courseName' => 'Hardware+','status' => '1'),
        array('id' => '39','courseName' => 'Affiliate / Digital Marketing','status' => '1'),
        array('id' => '40','courseName' => 'Linux - RHCE','status' => '1'),
        array('id' => '41','courseName' => 'Linux - RHCSA','status' => '1'),
        array('id' => '42','courseName' => 'Ethical Hacking','status' => '1'),
        array('id' => '43','courseName' => 'MGAP','status' => '1'),
        array('id' => '44','courseName' => 'CCNA Security','status' => '1'),
        array('id' => '45','courseName' => 'Digital Marketing','status' => '1'),
        array('id' => '46','courseName' => 'Finacial Excel','status' => '1'),
        array('id' => '47','courseName' => 'Customized Excel','status' => '1'),
        array('id' => '48','courseName' => 'Motion Graphics (online)','status' => '1'),
        array('id' => '49','courseName' => 'Excel Professional Part1 (online)','status' => '1'),
        array('id' => '50','courseName' => 'Excel Professional Part2 (online)','status' => '1'),
        array('id' => '51','courseName' => 'Excel Professional Part2 (online)','status' => '1'),
        array('id' => '52','courseName' => 'Excel Professional Part3 (online)','status' => '1'),
        array('id' => '53','courseName' => 'Programming with Advance C & C++ (online)','status' => '1'),
        array('id' => '54','courseName' => 'MS Office for Kids','status' => '1'),
        array('id' => '55','courseName' => 'Writing Business Document','status' => '1'),
        array('id' => '56','courseName' => 'Python for Web Apps Development (Django)','status' => '1'),
        array('id' => '57','courseName' => 'Python for Desktop Apps Development','status' => '1'),
        array('id' => '58','courseName' => 'Machine Learning','status' => '1'),
    );
    return $courses;
}
...
function references() {
    $references = array(
        array('id' => '1','refName' => 'Walk In','status' => '1'),
        array('id' => '2','refName' => 'Cold Call','status' => '1'),
        array('id' => '3','refName' => 'Social Network','status' => '1'),
        array('id' => '4','refName' => 'Referral','status' => '1'),
        array('id' => '5','refName' => 'Phone Query','status' => '1'),
        array('id' => '6','refName' => 'Walk In - Evening','status' => '1'),
        array('id' => '7','refName' => 'Special Promotion (SSC/HSC)','status' => '1'),
        array('id' => '8','refName' => 'NH Facebook ref - GM','status' => '1'),
        array('id' => '9','refName' => 'Xfer A/c.','status' => '1'),
    );
    return $references;
}
