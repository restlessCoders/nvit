...
<div class="row">
	<div class="col-12">
		<div class="page-title-box">
			...
			<h4 class="page-title">Add New Batch Slot</h4>
		</div>
	</div>
	<div class="col-12">
		<div class="card-box">
			<form action="{{ route(currentUser().'.batchslot.store') }}" method="POST" enctype="multipart/form-data">
				@csrf
				<input type="hidden" value="{{ Session::get('user') }}" name="userId">
				<div class="form-group row">
					<div class="col-lg-4">
						<label>Batch Slot: <span class="text-danger sup">*</span></label>
						<input type="text" name="slotName" value="{{ old('slotName') }}" class="form-control @if($errors->has('slotName')) {{ 'is-invalid' }} @endif" placeholder="Batch Slot" />
