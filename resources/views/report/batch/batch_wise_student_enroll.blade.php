	...
	<div class="col-12">
		<div class="card-box">
			...
			<div class="col-md-12">
				...
				<p class="m-0 text-left text-center"><strong>Batch Slot: @php echo date('d-m-Y',strtotime($batchInfo->batchslot?slotName)) @endphp</strong></p>
				<p class="m-0 text-left text-center"><strong>Batch Time: @php echo date('d-m-Y',strtotime($batchInfo->batchtime?time)) @endphp</strong></p>
