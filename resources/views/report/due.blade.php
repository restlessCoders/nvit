...
<div class="row">
	<div class="col-12">
		<div class="page-title-box">
			...
			<h4 class="page-title">Due Report</h4>
		</div>
	</div>
	<div class="col-12">
		<div class="card-box">
			<div class="col-md-12 text-center">
				...
				<p class="p-0" style="font-size:16px"><strong>Due Report</strong></p>
			</div>

			<form action="{{route(currentUser().'.dueReport')}}" method="" role="search">
				@csrf
				<div class="row">
					...
					<div class="col-sm-12 d-flex justify-content-end my-1">
						...
						<a href="{{route(currentUser().'.dueReport')}}" class="reset-btn btn btn-warning"><i class="fa fa-undo fa-sm"></i></a>
					</div>
				</div>
			</form>
			{{-- <div class="row pb-1">
			...
			<table class="table table-sm table-bordered table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
				...
				<tbody>
					...
					@php $total += $report->total_due;@endphp
					<tr>
						<td>{{ $key + 1 }}</td>
