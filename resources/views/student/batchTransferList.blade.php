...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Batch Transfer List</h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card-box">
        <table class="mt-3 responsive-datatable table table-bordered table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{\DB::table('batches')->where('id',$transfer->curbatchId)->first()->batchId}}</td>
                    <td>{{\DB::table('batches')->where('id',$transfer->newbatchId)->first()->batchId}}</td>
                    <td>{{$transfer->note}}</td>
