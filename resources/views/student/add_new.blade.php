...
<div class="row">
    ...
    <div class="form-group row">
        ...
        @endif
        @if(currentUser() == 'superadmin' || currentUser() == 'operationmanager' || currentUser() == 'salesmanager' || currentUser() == 'frontdesk')
        <div class="col-lg-4 row mt-3">
        ...
        <div class="col-lg-6 row mt-3">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="executiveNote" name="executiveNote" rows="5" placeholder="Note" style="
                                resize:none;"></textarea>
            </div>
        </div>
        @endif
