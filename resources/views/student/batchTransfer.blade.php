            ...
            <form action="{{ route(currentUser().'.transfer') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                            ...
                            <label for="note" class="col-sm-2 col-form-label">Operation Note</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="operationNote" name="note" rows="5" placeholder="Operation Note" style="
