                ...
                <div class="container-fluid">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu @if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager' || currentUser() == 'salesexecutive' || currentUser() == 'accountmanager') @else d-none @endif">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="@if(currentUser() == 'superadmin' || currentUser() == 'operationmanager' || currentUser() == 'salesmanager' || currentUser() == 'salesexecutive' || currentUser() == 'accountmanager') {{route(currentUser().'.package.index')}} @endif">All Package</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-submenu @if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager') @else d-none @endif">
                            ...
                            <li class="has-submenu @if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager' || currentUser() == 'salesexecutive' || currentUser() == 'frontdesk') @else d-none @endif">
                                <a href="#">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="@if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager') @else d-none @endif"><a href="@if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager') {{route(currentUser().'.studentTransfer')}} @endif">Student Transfer</a></li>
                                    <li class="@if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager') @else d-none @endif"><a href="@if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager') {{route(currentUser().'.studentTransferList')}} @endif">Student Transfer List</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="@if(currentUser() == 'superadmin' || currentUser() == 'operationmanager') @else d-none @endif">
                                        <a href="@if(currentUser() == 'superadmin' || currentUser() == 'operationmanager') {{route(currentUser().'.batchTransfer')}} @endif">Batch Transfer</a>
                                    </li>
                                    <li class="@if(currentUser() == 'superadmin' || currentUser() == 'operationmanager') @else d-none @endif"><a href="@if(currentUser() == 'superadmin' || currentUser() == 'operationmanager') {{route(currentUser().'.batchTransferList')}} @endif">Batch Transfer List</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu @if(currentUser() == 'superadmin' || currentUser() == 'trainingmanager' || currentUser() == 'salesmanager' || currentUser() == 'operationmanager' || currentUser() == 'salesexecutive' || currentUser() == 'accountmanager' || currentUser() == 'frontdesk') @else d-none @endif">
                                <a href="#">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu @if(currentUser() == 'superadmin' || currentUser() == 'operationmanager' || currentUser() == 'accountmanager') @else d-none @endif">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="@if(currentUser() == 'superadmin' || currentUser() == 'operationmanager' || currentUser() == 'accountmanager') {{route(currentUser().'.regReport')}} @endif">Reg Report (Date Range)</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu @if(currentUser() == 'superadmin' || currentUser() == 'salesmanager' || currentUser() == 'trainingmanager' || currentUser() == 'salesexecutive' || currentUser() == 'operationmanager' || currentUser() == 'trainer' || currentUser() == 'frontdesk' || currentUser() == 'accountmanager') @else d-none @endif">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="@if(currentUser() == 'superadmin' ||  currentUser() == 'trainingmanager' || currentUser() == 'operationmanager' || currentUser() == 'trainer') {{route(currentUser().'.batchwiseCompletion')}} @endif">Report</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
