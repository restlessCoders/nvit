		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-success card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">New Bill</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stats Widget 25-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-danger card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">New Purchese</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stats Widget 26-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-info card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">Book Appointment</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stats Widget 27-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-warning card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">New Customer</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stat: Widget 28-->
	...
	<div class="row">
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-success card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">Bill List</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stats Widget 25-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-danger card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">Purchese List</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stats Widget 26-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-info card-stretch gutter-b">
				<!--begin::Body-->
				<div class="card-body">
				    <a href="{{route(currentUser().'.allAppointment')}}">
					<span class="svg-icon svg-icon-2x">
						<i class="icon-2x text-dark-50 flaticon-list-3"></i>
					</span>
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">Appointment List</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stats Widget 27-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom bg-light-warning card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-2 d-block">New Supplier</span></a>
				</div>
				<!--end::Body-->
			</div>
			<!--end::Stat: Widget 28-->
		...
		<div class="col-xl-4">
			...
			<div class="card card-custom bg-radial-gradient-danger gutter-b card-stretch">
				...
				<div class="card-body d-flex flex-column p-0">
					<!--begin::Chart-->
					<div id="kt_mixed_widget_6_chart" style="height: 180px"></div>
					<!--end::Chart-->
					<!--begin::Stats-->
					<div class="card-spacer bg-white card-rounded flex-grow-1">
						...
						<div class="row m-0">
							<div class="col-12 mb-1">
								...
								<div class="font-size-h4 font-weight-bolder">{{$company->currency_symble}}
								    @php $pro=0; @endphp
								@if($profit)
								    @foreach($profit as $p)
							...
							<div class="col-12 mb-1">
								...
								<div class="font-size-h4 font-weight-bolder">{{$company->currency_symble}}{{ $tRevenue==0?0:round($tRevenue/$rcount) }}</div>
							</div>
							<div class="col-12 mb-1">
								<div class="font-size-sm text-muted font-weight-bold">Annual Income</div>
								<div class="font-size-h4 font-weight-bolder">{{$company->currency_symble}}{{round($tRevenue)}}</div>
							</div>
						</div>
						<!--end::Row-->
					</div>
		...
		<div class="col-xl-8">
			...
			<div class="row">
				<div class="col-xl-4">
					...
					<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url(assets/media/stock-600x400/img-28.jpg)">
						<!--begin::Body-->
						<div class="card-body">
