...
// 	dd($rev_date);
	if($rev_date){
		...
		foreach($rev_date as $rd){
		  //  dd($montharr[$rd->bd].' '.$company['currency_symble'].$rd->tm . ',');
			$Revenue.=round(($rd->tm*100)/$tRevenue).', ';
			$month.=$montharr[$rd->bd - 1].' '.$company['currency_symble'].$rd->tm . ',';
		}
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card card-custom gutter-b" style="height: 180px">
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            ...
                            <!--end::Stats-->
                            <!--begin::Chart-->
                            <div id="kt_tiles_widget_22_chart" class="card-rounded-bottom" data-color="info"
                                style="height: 100px"></div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Body-->
            ...
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b h-100"
                        ...
                        <!--begin::Body-->
                        <div class="card-body">
                            <a href='#' class="text-dark-75 text-hover-primary font-weight-bolder font-size-h3">This
                                Month Sales</a>
                            <div class="text-dark-50 font-weight-bold font-size-lg pt-2">
                                @if($billMonth)
