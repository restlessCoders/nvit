							...
							<div class="form-group row">
								<div class="image-input image-input-outline" id="kt_image_1">
									...
									<div class="image-input-wrapper"
										style="background-image: url({{asset("storage/images/user/photo/$photo")}})">
									</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-4">
									...
									<select name="timezone"
										class="form-control select2 tz @if($errors->has('role')) {{ 'is-invalid' }} @endif">
										@if(count($timezones) > 0)
										@foreach($timezones as $key=>$value)
										<option value="{{ $key }}" @if($key==$user->timezone) selected @endif
											>{{ $value }}</option>
										@endforeach
										@endif
									</select>
