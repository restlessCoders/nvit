							...
							<tr>
								...
								<td>
									...
									<table>
										...
										<tr>
											<td colspan="3" class="text-danger">Validity {{\Carbon\Carbon::createFromTimestamp(strtotime($package->startDate))->format('j M, Y')}} - {{\Carbon\Carbon::createFromTimestamp(strtotime($package->endDate))->format('j M, Y')}}</td>
										</tr>
									</table>
									@else
									No Offer
